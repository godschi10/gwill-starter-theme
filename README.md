...
**Latest version: 1.13.4** - the search dropdown hoists out of the sticky header's stacking context on first open, so nothing can ever paint over it (the King's z-index report, adversarially proven). 1.13.3/1.13.2 shipped Section B. Full history in `CHANGELOG.md`.
