...
**Latest version: 1.10.12** — vibe-comments integration hardening (guard 3.6.3, `should_render()` enqueue gate, dark-state coverage port). Full history in `CHANGELOG.md`.
